    ...
    <div className='bg-[#F6F9FC] text-gray-500/80 pt-8 px-6 md:px-16 lg:px-24 xl:px-32'>
      <div className='flex flex-wrap justify-between gap-12 md:gap-6'>
        <div className='max-w-80'>
          ...
          <p className='text-sm'>
            Discover the world's best stays with us. From cozy homes to luxurious villas, we offer a wide range of accommodations to suit every traveler's needs. Whether you're planning a weekend getaway or a long vacation, our platform makes it easy to find and book your perfect stay.
          </p>
